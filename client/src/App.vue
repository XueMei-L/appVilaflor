<template>
  ...
  <div class="home-page">
      ...
      <a target="_self" href=""> REGISTAR </a>
	</div>
  <router-view/>
  ...
  <footer class="footer-distributed">
	<div class="footer-left">
      ...
      <a target="_self" href="/footer/privacidad">
          <button class="button">PRIVACIDAD</button></a>
      <a target="_self" href="/footer/termino_de_uso">
          <button class="button">TERMINOS DE USO</button></a>
      <a target="_self" href="/footer/aviso_legal">
          <button class="button">AVISO LEGAL</button></a>
      <a target="_self" href="/footer/empleo">
          <button class="button">EMPLEO</button></a>
		</div>
