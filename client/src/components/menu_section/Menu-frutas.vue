...
<div>
  ...
  <body>
    ...
    <div class="page-background">
        ...
        <div class="polaroid" style="background-color:#ffffff; border-radius: 10px;">
            <a target="_self" href="/fruits">
            <img src="../imagenes/f5.jpg" alt="Norway" style="width:90%; margin:10px; border-radius: 10px;">
            </a>
            <p align="left" style="margin-left:5px; margin-bottom:10px; color:#B2B2B2;">Por precio/Kilo</p>
            <b>MANZANAS ROJAS</b><br><br>
            <b align="right" style="margin-right:5px; color:#3885ff; font-size: 15px;">2,29 €/Kg</b><br><br>
        ...
        <div class="polaroid" style="background-color:#ffffff; border-radius: 10px;">
            <a target="_self" href="/fruits">
            <img src="../imagenes/f6.jpg" alt="Norway" style="width:90%; margin:10px; border-radius: 10px;">
            </a>
            <p align="left" style="margin-left:5px; margin-bottom:10px; color:#B2B2B2;">Por precio/Kilo</p>
            <b>MANZANAS</b><br><br>
            <b align="right" style="margin-right:5px; color:#3885ff; font-size: 15px;">2,29 €/Kg</b><br><br>
        ...
        <div class="polaroid" style="background-color:#ffffff; border-radius: 10px;">
            <a target="_self" href="/fruits">
            <img src="../imagenes/f7.jpg" alt="Norway" style="width:90%; margin:10px; border-radius: 10px;">
            </a>
            <p align="left" style="margin-left:5px; margin-bottom:10px; color:#B2B2B2;">Por precio/Kilo</p>
            <b>MANZANAS</b><br><br>
            <b align="right" style="margin-right:5px; color:#3885ff; font-size: 15px;">2,29 €/Kg</b><br><br>
        ...
        <div class="polaroid" style="background-color:#ffffff; border-radius: 10px;">
            <a target="_self" href="/fruits">
            <img src="../imagenes/f8.jpg" alt="Norway" style="width:90%; margin:10px; border-radius: 10px;">
            </a>
            <p align="left" style="margin-left:5px; margin-bottom:10px; color:#B2B2B2;">Por precio/Kilo</p>
            <b>MANZANAS</b><br><br>
            <b align="right" style="margin-right:5px; color:#3885ff; font-size: 15px;">2,29 €/Kg</b><br><br>
